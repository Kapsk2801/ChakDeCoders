          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200">
                <div className="text-center mb-4">
                  <div className="flex items-center justify-center gap-2 mb-3">
                    ...
                    <h3 className="text-xl font-bold text-gray-900">AI-Powered Tools</h3>
                    <Zap className="w-8 h-8 text-yellow-500 animate-bounce" />
                  </div>
                  <p className="text-gray-600 text-sm">
                    Experience the future of profile creation!
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ARSkillPreview skills={[...profile.skillsOffered, ...profile.skillsWanted]} user={profile} />
                <SkillMatchVisualizer currentUser={profile} allUsers={allUsers} />
              </div>
            </motion.div>
          </div>
        </div>
